...
var d: Any// could be anything
var c: AnyObject //for ant class
c = UIColor.red
//c = nil //have to have optional var c: AnyObject?(optional type)
...
y = Int(s1)
y = Int(s2)//nil not covertable


//: 2. Properties that cannot be initialized when an object is constructed
class ViewController: UIViewController {
    var button: UIButton!//implicityly unwrapped optional
}
...
z = Int(string)
//z * 2
if let unz = z{//saver way to unwrape
    print(unz * 2);
}
z! * 2
...
class AnotherViewController: UIViewController {
    ...
    var anotherButton2: UIButton?
    var anotherButton3: UIButton!
...
func pickUpGroceries(_ car:Car?) {
    //guard let car = car else {return}//other wat to unwrap, if car is not nil then car = car , if is nil just return
