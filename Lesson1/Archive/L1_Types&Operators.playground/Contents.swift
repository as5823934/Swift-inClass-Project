...
class LightSwitch { //initial in the class or using init
    
    var on: Bool = true //every variable must have init value
    var num: Int = 10;
}

var livingRoomSwitch = LightSwitch()
livingRoomSwitch.on //access the property
livingRoomSwitch.num
...
var concatenatedString2:String = "\(myFirstSwiftString), \(mySecondSwiftString)" //string Interpolator
...
var pic = UIImage(named:"Chloe.png")!// '!' unwrap the optional
